    ...
    <div className="min-h-screen bg-[#f8f6f0]">
      ...
      <div className="relative bg-[#0a3620] pt-32 pb-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <p className="text-xs tracking-[0.3em] uppercase text-[#4ade80] mb-4 font-sans font-medium">Our Story</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 -mt-12 relative z-10 mb-20">
          {stats.map((stat, idx) => {
            const Icon = stat.icon;
            return (
              <div key={idx} className="bg-white p-8 text-center border border-gray-100 hover:border-[#15803d]/30 transition-all duration-300 shadow-sm">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <p className="text-xs tracking-[0.3em] uppercase text-[#15803d] mb-4 font-sans font-medium">Our Core Values</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((value, idx) => {
              ...
              return (
                <div key={idx} className="bg-white p-10 text-center border border-gray-100 hover:border-[#15803d]/30 transition-all duration-300">
